...
public class JyperionListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
		      ...
		      CommonFunctions.takeSnapShot(DriverScript.driver,file);
	...
	public void onStart(ITestContext context) {
		log("onStart("+context+")");
		try {
			PdfWriter.getInstance(this.document, new FileOutputStream(System.getProperty("user.dir")+"\\ARTDesktopAutomation_Test_Report"+".pdf"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		this.document.open();
